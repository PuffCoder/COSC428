...
def getOutputsNames(net):
    ...
    # Get the indexes of the layers with unconnected outputs, i.e., the output layers
    # Newer versions of OpenCV return a list for getUnconnectedOutLayers(), adjust accordingly
